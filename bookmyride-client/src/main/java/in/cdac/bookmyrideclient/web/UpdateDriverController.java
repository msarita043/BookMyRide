...
public class UpdateDriverController {
	...
	public String updateDriverPost(@Valid @ModelAttribute("updateDriverForm") UpdateDriverForm updateDriverForm, BindingResult bindingResult, Model model, HttpSession httpSession,
		...
		Users u = new Users();
		u.setName(updateDriverForm.getName());
		Driver d = driverService.getDriver(updateDriverForm, u);
		driverService.updateDriver(d, driverId);
